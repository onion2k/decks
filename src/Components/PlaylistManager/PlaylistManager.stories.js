...
const playlists = [];
const playlistsWithLists = [
  { title: "Playlist 1", playlistId: "pl1", length: 6 },
  { title: "Playlist 2", playlistId: "pl2", length: 6 },
  { title: "Playlist 3", playlistId: "pl3", length: 6 }
];
